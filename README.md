...
void lcd_display()
{
	...
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"J I V A N\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212222100017\n");
	HAL_Delay(2000);
...
![image](https://github.com/JivanKarthick/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/121165867/01987e4a-a2f8-43fa-825b-adea417a7f48)

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

![image](https://github.com/JivanKarthick/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/121165867/238cf734-2cc5-46ea-847c-ef2faaf2830f)
